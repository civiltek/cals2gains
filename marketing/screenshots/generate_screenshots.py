...
def dash_content(d, px, py, pw, ph):
    ...
    by = cy+r+50
    for name, prog, color in [("Proteina",0.7,ACCENT),("Carbohidratos",0.55,PRIMARY),("Grasa",0.4,YELLOW)]:
...
make_screenshot("Tu nutricion diaria", "de un vistazo", dash_content,
    ["Seguimiento de calorias en tiempo real","Macros detallados: proteina, carbohidratos, grasa","Historial completo de comidas"],
