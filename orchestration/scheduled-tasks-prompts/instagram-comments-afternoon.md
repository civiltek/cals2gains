...
Run the afternoon Instagram commenting round for Cals2Gains. Post ~10 high-value nutritional comments across fitness/nutrition influencer posts, rotando entre las tres cuentas según el idioma del influencer. Execute fully autonomously — do not ask for confirmation on individual comments.
...
## CRITICAL: Check Morning Round Log

Before starting, read `/sessions/brave-festive-feynman/mnt/Cals2Gains/skills/instagram-commenter/references/daily-log.md` to see which influencers were already used in today's morning round. You MUST use DIFFERENT influencers for this afternoon round. If the file doesn't exist or has no entry for today, proceed normally but still avoid repeating influencers you use within this session.
...
2. Visit 3-4 Spanish influencers from the ✅ Verified list que NO se hayan usado en la ronda de mañana. If the main ones were used, discover new accounts via hashtag search (#nutriciondeportiva, #realfooding, #comidafit) or try ⚠️/🔍 accounts.
...
2. Visit 2-3 English influencers que NO se hayan usado en la ronda de mañana.
3. Before commenting, verify no existing comment from @cals2gains NI de @calstogains on that post.
...
2. Visit 2-3 English influencers DIFERENTES de los usados en Phase 2A y de los de la ronda de mañana.
...
- NEVER use the same influencer that was already used in today's morning round — check the daily-log.md file.
- Dentro de esta misma ronda, un mismo influencer no debe recibir comentarios de dos cuentas distintas.
- To track this round: after finishing, APPEND your influencers (con la cuenta que comentó cada uno) to `/sessions/brave-festive-feynman/mnt/Cals2Gains/skills/instagram-commenter/references/daily-log.md` under today's date entry.
...
2. Append to `/sessions/brave-festive-feynman/mnt/Cals2Gains/skills/instagram-commenter/references/daily-log.md` with the afternoon influencers (con la cuenta usada) y comment count.
